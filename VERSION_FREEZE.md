...
- 本仓库：`Liiiin-hku/compact-vision-tactile-sensor`，默认分支 `main`。
...
- 英文展示与命名更新：2026-09-12；外层展示文档版本 `portfolio-2026-09-12-en`，默认英文 README。用户明确授权更改现有仓库名称，软件来源 commit 与技术资产不变。
