...
if __name__ == '__main__':
    ...
    while sensor.cap.isOpened():
        ...
        # The legacy Open3D visualizer consumes normalized values. Physical
        # predictions are available through Estimator.predict_force().
        force = estimator.predict_normalized(representation)
