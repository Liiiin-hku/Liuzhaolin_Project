...
![](../../../../02_Software/Final_Repository_Snapshot/Original/source/pipelie.png)
...
Then, 3d print the [calibration board](../../../../02_Software/Final_Repository_Snapshot/Original/9DTact_Design/fabrication/calibration_board.STL).<br>
Run:
```bash
...
by modifying the 'weights' parameters in the [force_config.yaml](../../../../02_Software/Final_Repository_Snapshot/Original/force_estimation/force_config.yaml).<br>
After that, run:
```bash
cd force_estimation
